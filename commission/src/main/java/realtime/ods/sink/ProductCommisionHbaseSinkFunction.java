 ...
 * @date 2021/6/2 15:36
 */
public class ProductCommisionHbaseSinkFunction extends AbstractHbaseSinkFunction<ProductCommision> {
    public ProductCommisionHbaseSinkFunction() {
        tableName = "t_product_commision";
    }

    @Override
    public void handle(ProductCommision value, Context context, HTable table) throws Exception {
