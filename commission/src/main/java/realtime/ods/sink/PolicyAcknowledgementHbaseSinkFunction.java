 ...
 * @date 2021/6/2 14:43
 */
public class PolicyAcknowledgementHbaseSinkFunction extends AbstractHbaseSinkFunction<PolicyAcknowledgement> {
    public PolicyAcknowledgementHbaseSinkFunction() {
        tableName = "t_policy_acknowledgement";
    }

    @Override
    public void handle(PolicyAcknowledgement value, Context context, HTable table) throws Exception {
