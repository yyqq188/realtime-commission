 ...
 * @date 2021/6/2 14:40
 */
public class DefinePolicyAcknowledgementHbaseTable {
    public static void definePolicyAcknowledgement(StreamTableEnvironment tableEnv, Configuration conf) {
        HBaseTableSource hBaseTableSource = new HBaseTableSource(conf, "t_policy_acknowledgement");
