 ...
 * @date 2021/6/2 15:36
 */
public class DefineProductCommisionHbaseTable {
    public static void defineProductCommision(StreamTableEnvironment tableEnv, Configuration conf) {
        HBaseTableSource hBaseTableSource = new HBaseTableSource(conf, "t_product_commision");
